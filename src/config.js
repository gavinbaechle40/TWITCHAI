export const config = {
  ...
  randomEventIntervalMinMs: Number(process.env.RANDOM_EVENT_INTERVAL_MIN_MS || 900000),
  randomEventIntervalMaxMs: Number(process.env.RANDOM_EVENT_INTERVAL_MAX_MS || 1800000),
  randomEventDurationMs: Number(process.env.RANDOM_EVENT_DURATION_MS || 60000),
  ...
  maxReplyChars: Number.isFinite(Number(process.env.MAX_REPLY_CHARS))
  ? Number(process.env.MAX_REPLY_CHARS)
  : 280,
};
